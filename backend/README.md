...
so you can demo the admin approval queue), 4 customers, and 15 days of
...
Re-run `npm run seed` anytime to reset to a clean demo state before a
rehearsal or the actual judging round.
